...
<head>
	...
	<title>KPLink Store Management - Add Customer</title>
</head>
...
mysqli_query($con,"INSERT INTO customer (CUST_FIRST_NAME,CUST_LAST_NAME,CUST_PHONE_NUMBER,CUST_EMAIL_ADDRESS,CUST_CITY,CUST_STATE,CUST_ZIP_CODE,ACCT_CLASS) VALUES ('$firstname','$lastname','$number','$email','$city','$state','$zipcode','$acctclass')");
...
<form id="addcust" name="addcust" method="post" action=""
	   <table cellspacing="0" cellpadding="5" border="0">
		...
		<tr>
		<td>Account Class</td>
		<td><input id="acctclass" name="acctclass" type="text" style="display:block"/></td>
		</tr>
		<tr>
