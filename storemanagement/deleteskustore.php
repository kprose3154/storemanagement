...
<head>
	...
	<title>KPLink Store Management - Delete SKU Store</title>
</head>
...
if ($choice == 1)
{
	mysqli_query($con,"DELETE FROM `sku_store` WHERE `SKU_ID`=$id");
...
?>
	   ...
	   <p>Are you sure you want to delete this skustore?</p>
